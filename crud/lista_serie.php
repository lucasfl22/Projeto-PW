...
<?php
    ...
    $sql = mysqli_query($conexao,"SELECT * FROM posts WHERE tipo = 'serie'");
    ...
    while($tabela = mysqli_fetch_array($sql)){
        ...
        if (isset($_SESSION['id_usuario']) && $_SESSION['id_usuario'] == $tabela['usuario_id']) {
            echo "<a href='exclui_post.php?id=$tabela[id]&tipo=serie'><b>[X] Excluir</b></a> | ";
            echo "<a href='form_edita_post.php?id=$tabela[id]&tipo=serie'><b>[V] Editar</b></a> <br>";
        } echo "<hr>";
    }
